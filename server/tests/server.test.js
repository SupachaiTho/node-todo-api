...
describe('GET /todos/:id', ()=>{
    ...
    it('should not return todo doc careted by other user',(done)=>{
        request(app)
...
describe('DELETE /todos/:id', ()=>{
    ...
    it('should not remove doc todo',(done)=>{
...
describe('POST /users',()=>{
    ...
    it('should not create user if email in use',(done)=>{
        request(app)
            .post('/users')
            .send({email:users[0].email,passwor:'Password123!'})
            .expect(400)
            .end(done)
    })
})
